...
public class ValidateDeleteSchedule {
	...
	public void testDeleteSchedule() throws IOException {
		...
		PostResponse dspost = new Gson().fromJson(dsoutput.toString(), PostResponse.class);
		DeleteScheduleResponse dsresp = new Gson().fromJson(dspost.body, DeleteScheduleResponse.class);
		System.out.println(dsresp);
		
		Assert.assertEquals("Successfully delete schedule :" + scheduleid, dsresp.message);
	}
}
